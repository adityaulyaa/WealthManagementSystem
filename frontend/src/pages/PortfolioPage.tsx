  ...
  return (
    <>
        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          <main className="flex-1 overflow-y-auto px-6 lg:px-10 py-8 space-y-6">
            <PortfolioToolbar
              ...
              onNewPortfolio={crud.handleNewPortfolio}
            />
            {loading ? (
              ...
              <>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.4fr] gap-5">
                  <PortfolioDetail
                    ...
                    onEditPortfolio={() => crud.handleEditPortfolio(selectedPortfolio)}
                    onDeletePortfolio={crud.handleDeletePortfolio}
                  />
      ...
      <PortfolioModal
        open={crud.modalOpen}
        mode={crud.modalMode}
        portfolioName={crud.portfolioName}
        portfolioType={crud.portfolioType}
        riskLevel={crud.riskLevel}
        setPortfolioName={crud.setPortfolioName}
        setPortfolioType={crud.setPortfolioType}
        setRiskLevel={crud.setRiskLevel}
        onClose={crud.handleCloseModal}
        onSubmit={() => crud.handleSubmitPortfolio(selectedPortfolio ? parseInt(selectedPortfolio.id) : undefined)}
        isSubmitting={crud.isSubmitting}
      />

      <ConfirmationModal
        open={crud.deleteConfirmationOpen}
